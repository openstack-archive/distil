...
@mock.patch.object(general, 'get_transformer_config', FAKE_CONFIG)
class TestUpTimeTransformer(base.DistilTestCase):
    def setUp(self):
        super(TestUpTimeTransformer, self).setUp()

        self.xform = conversion.UpTimeTransformer()
    ...
    def test_trivial_run(self):
        ...
        result = self.xform.transform_usage('state', state, FAKE_DATA.t0,
                                            FAKE_DATA.t1)
    ...
    def test_online_flavor_change(self):
        ...
        self.assertDictEqual({FAKE_DATA.flavor: 1800, FAKE_DATA.flavor2: 1800},
                             result)
...
class TestFromImageTransformer(base.DistilTestCase):
    ...
    def setUp(self):
        super(TestFromImageTransformer, self).setUp()

        self.xform = conversion.FromImageTransformer()
    ...
    def test_from_volume_case(self):
        ...
        usage = self.xform.transform_usage('instance', data, FAKE_DATA.t0,
                                           FAKE_DATA.t1)
        usage2 = self.xform.transform_usage('instance', data2, FAKE_DATA.t0,
                                            FAKE_DATA.t1)
...
class TestNetworkServiceTransformer(base.DistilTestCase):
    def setUp(self):
        super(TestNetworkServiceTransformer, self).setUp()

        self.xform = conversion.NetworkServiceTransformer()
    ...
    def test_basic_sum(self):
        ...
        usage = self.xform.transform_usage('fake_meter', data, FAKE_DATA.t0,
                                           FAKE_DATA.t1)
