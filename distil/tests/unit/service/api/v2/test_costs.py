...
class TestCostServiceAPI(base.DistilTestCase):
    ...
    def test_get_costs_last_three_month_to_today(self,
                                                 mock_get_products,
                                                 mock_resources,
                                                 mock_usage_get,
                                                 mock_load_erp,
        ...
        # Call target method.
        self.override_config('keystone_authtoken', region_name='fake_region')
        cost = costs.get_costs('fake_project_Id', str(start), str(end))
    ...
    def test_get_costs_current_month(self,
        ...
        erp_driver = mock.Mock()
        mock_load_erp.return_value = erp_driver
        erp_driver.get_costs.return_value = []
