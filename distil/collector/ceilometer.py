...
class CeilometerCollector(base.BaseCollector):
    def __init__(self, *arg, **kwargs):
        ...
        self.cclient = client.get_client(
            '2',
            os_username=CONF.keystone_authtoken.admin_user,
            os_password=CONF.keystone_authtoken.admin_password,
            os_tenant_name=CONF.keystone_authtoken.admin_tenant_name,
            os_auth_url=CONF.keystone_authtoken.identity_uri
        )
