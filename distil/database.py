...
class Database(object):
    ...
    def _get_os_distro(self, entry):
        ...
        # Ceilometer polster or sent by notification. For instance booted from
        # volume the value is null in MongoDB.
        if entry['resource_metadata'].get('image_ref_url', None):
            # Boot from image
